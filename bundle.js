...
var _user$project$RemainingDaysWidget$remainingDays = function (model) {
	var _p0 = model.endDate;
	if (_p0.ctor === 'Nothing') {
		return 0;
	} else {
		...
		if (_p1.ctor === 'Nothing') {
			...
			return A3(_justinmimbs$elm_date_extra$Date_Extra$diff, _justinmimbs$elm_date_extra$Date_Extra$Day, _p1._0, _p0._0);
		}
	}
};
var _user$project$RemainingDaysWidget$view = function (model) {
	return A2(
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(
									_user$project$RemainingDaysWidget$remainingDays(model))),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$RemainingDaysWidget$updateTodayDate = F2(
	function (model, time) {
...
var _user$project$RemainingDaysWidget$update = F2(
	function (msg, model) {
		var _p2 = msg;
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$RemainingDaysWidget$updateTodayDate, model, _p2._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$RemainingDaysWidget$Model = F2(
	function (a, b) {
		return {startDate: a, endDate: b};
	});
var _user$project$RemainingDaysWidget$initialModel = A2(_user$project$RemainingDaysWidget$Model, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
var _user$project$RemainingDaysWidget$init = {ctor: '_Tuple2', _0: _user$project$RemainingDaysWidget$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$RemainingDaysWidget$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$RemainingDaysWidget$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$RemainingDaysWidget$Tick);
};

var _user$project$Main$todayWidgetModel = {
	startDate: _elm_lang$core$Maybe$Nothing,
	endDate: _elm_lang$core$Maybe$Just(
		A3(_justinmimbs$elm_date_extra$Date_Extra$fromCalendarDate, 2017, _elm_lang$core$Date$Feb, 18))
};
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('tile is-vertical is-8'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('tile is-parent is-vertical'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('tile is-child notification is-primary'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: A2(
																...
																_user$project$RemainingDaysWidget$view(model.widgetModel)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('tile is-child notification is-warning'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('tile is-child notification is-danger'),
														_1: {ctor: '[]'}
													},
													{ctor: '[]'}),
												_1: {ctor: '[]'}
...
var _user$project$Main$update = F2(
	function (message, model) {
		var _p0 = message;
		var _p1 = A2(_user$project$RemainingDaysWidget$update, _p0._0, model.widgetModel);
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				_user$project$Main$WidgetMsg,
				_user$project$RemainingDaysWidget$subscriptions(model.widgetModel)),
			_1: {ctor: '[]'}
		});
};
